-- ============================================================================
-- IMMEDIATE FIX for 500 Error - Run this SQL now
-- ============================================================================
-- 
-- This adds SECURITY DEFINER to the RPC functions so they can insert/update
-- ratings even with RLS enabled.
-- 
-- Run this in your Supabase SQL Editor.
-- 
-- ============================================================================

-- Fix upsert_player_rating
...
-- Fix upsert_player_double_rating
