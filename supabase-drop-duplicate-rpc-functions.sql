-- ============================================================================
-- Drop Duplicate RPC Functions
-- ============================================================================
-- 
-- Problem: There are TWO versions of each RPC function:
--   1. One with p_elo_delta INTEGER
--   2. One with p_elo_delta NUMERIC
-- 
-- PostgreSQL can't choose which one to use, causing:
--   "Could not choose the best candidate function between: ..."
-- 
-- Solution: Drop ALL versions, then recreate with only INTEGER version
-- (since code currently rounds to integers)
-- 
-- ============================================================================
...
-- ============================================================================
-- Recreate with ONLY INTEGER version (matching current code)
-- ============================================================================

-- Recreate upsert_player_rating (INTEGER version only)
...
-- Recreate upsert_player_double_rating (INTEGER version only)
...
-- Recreate upsert_double_team_rating (INTEGER version only)
