-- ============================================================================
-- Fix RPC Functions - INTEGER Version (Use if decimal migration NOT run yet)
-- ============================================================================
-- 
-- This version uses INTEGER for p_elo_delta.
-- Use this if you have NOT run the decimal migration yet.
-- 
-- After running the decimal migration, use supabase-fix-rpc-security.sql instead.
-- 
-- ============================================================================
