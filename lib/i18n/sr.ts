...
export const sr = {
	...
	missions: {
		title: "Misije",
		subtitle: "Sledeće rival priče",
		loading: "Učitavanje misija...",
		empty: "Još nema dovoljno podataka za tvoje misije.",
		updated: "Ažurirano",
		error: {
			fetchFailed: "Greška pri učitavanju misija",
		},
		tiers: {
	...
	statistics: {
		...
		rivalries: {
			...
			winRate: "% pobeda",
			streak: "Niz",
			lastPlayed: "Poslednji meč",
			loading: "Učitavanje rivalstava...",
			empty: "Još nema rivalstava",
			emptyDescription: "Rivalstva će se pojaviti nakon prvih singl mečeva.",
			error: "Greška pri učitavanju rivalstava",
		},
		table: {
			player: "Igrač",
			team: "Tim",
	...
	rankPlacements: {
		title: "Vreme po mestu",
		scope: "Singlovi",
		place: "mesto",
		longest: "Najduže",
		total: "Ukupno",
		distribution: "Raspodela vremena po mestu",
		session: "termin",
		sessions: "termina",
		loading: "Učitavanje mesta...",
		empty: "Nema dovoljno istorije za prikaz mesta.",
		error: "Greška pri učitavanju mesta",
	},
	sessions: {
		title: "Termini",
	...
	admin: {
		...
		missions: {
			title: "Misije",
			loading: "Učitavanje misija...",
			empty: "Nema generisanih misija.",
			regenerate: "Regeneriši sve",
			regenerating: "Regenerisanje...",
			generated: "Generisano",
			candidates: "Kandidati",
			selected: "Izabrano",
			playerSummary: "Pregled",
			error: {
				fetchFailed: "Greška pri učitavanju misija.",
				notAuthenticated: "Niste prijavljeni",
				unauthorized: "Nemate dozvolu za pristup",
				regenerateFailed: "Greška pri regenerisanju misija.",
			},
			success: {
				regenerated: "Misije su uspešno regenerisane.",
			},
		},
	},
	ispale: {
		...
		cards: {
			...
			topOffenders: "Rang lista poena ispala",
			noShows: "Ispala",
			points: "Poeni",
