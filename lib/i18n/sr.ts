...
export const sr = {
	...
	admin: {
		...
		emailTest: {
			...
			emailTitle: "Naslov",
			emailTitlePlaceholder: "Unesite naslov emaila",
			message: "Poruka",
			messagePlaceholder: "Unesite poruku koja će se prikazati u emailu",
			ctaLabel: "CTA label (opciono)",
			ctaLabelPlaceholder: "Npr. 'Otvori aplikaciju'",
			send: "Pošalji test email",
			sending: "Slanje...",
			success: "Email je uspešno poslat",
			error: {
				invalidEmail: "Neispravna email adresa",
				sendFailed: "Greška pri slanju emaila",
				generic: "Došlo je do greške. Pokušaj ponovo.",
			},
		},
	},
