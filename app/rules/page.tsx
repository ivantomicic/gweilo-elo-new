...
export default function RulesPage() {
	return (
		<AuthGuard>
			<AppShell title={t.pages.rules} contentPadding={false}>
					...
					<section className="max-w-3xl space-y-6">
						<div className="max-w-3xl space-y-2">
							...
							<p className="max-w-3xl text-sm leading-6 text-muted-foreground">
								Ova pravila određuju ko se vidi u statistici i
								na Top 3 podijumu. Rezultati i Elo se ne brišu
								ako igrač ili tim trenutno ne ispunjava uslove.
							</p>
						</div>
